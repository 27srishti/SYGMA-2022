        ...
        <div className="lg:w-1/3">
          ...
          >
            ...
            <span className="self-center text-2xl font-semibold">
              ...
              <p className="text-base font-sans mt-1 -mb-10"> sdmcbm@sdmcbm.ac.in</p>
              <br/><a className="  text-base underline" href="https://goo.gl/maps/PoU6vFtGEXSu8LED6">Google Maps</a>
            </span></center>
          </a>
        </div>
