        ...
        >
          ...
          <div className=" top-20 py-5 rounded-2xl border border-white-700 border-opacity-70  text-start  mx-auto w-10/12 lg:top-40 px-6 md:px-10 lg:px-16 xl:px-20 relative md:rounded-2xl border border-white-700 border-opacity-70 sm:rounded-2xl border border-white-700 border-opacity-70 bg-gray-900 bg-opacity-20 backdrop-blur-xl shadow-2xl  md:-mt-20 lg:-mt-24 xl:-mt-32 transition duration-700 group-hover:scale-95">
            ...
            <h1 className="px-10 text-start lg:px-28 lg:full sm:w-full">
              The mind is not a vessel to be filled but a fire to be kindled. IT
              Chaser is an event that can prove how bold, smart and competitive
              you are in a proffessional field. It is an event where
              participants can display their capability to communicate and
              interact whereas judges try to gauge participant's response.
            </h1>
            <br />
            ...
            <h5 className="px-10 lg:px-28  lg:full sm:w-full">
              {" "}
              - Good communication skill is necessary. <br />
              - Laptop with good internet connection is required. <br />- Should
              know C++/Java/Python (Any one)
            </h5>
            <br />{" "}
            <h5 className="mt-1 px-5 text-xl text-start text-gray-300 group-hover:text-white lg:px-20 lg:full sm:w-full">
              Co-ordinators:
            ...
            <h5 className="px-10 lg:px-28  lg:full sm:w-full">
              Anirudh Pai- 7204208365 <br />
              Arfa Banu- 9606851929
            </h5>
            <br />
          </div>
          <div className="lg:full">
            ...
            <h2 className="px-16 lg:w-full m-auto text-start text-1xl md:text-base  text-white mt-8 mb-16">
              ...
              participants are required to be in formals on the day of the fest.
              <br /> - A team has to participate in all the events to be in the
              ...
              sygma@sdmcbm.ac.in. <br /> - Participants are requested to produce
              their identity cards and Bonafide Certificate at the time of
              registration.
              <br /> - Punctuality and discipline are of primary concern. <br />
              - Team will refrain from smoking, drugs, alcohol consumption and
              misbehavior. Students indulging in such unacceptable behavior
              shall be disqualified. <br />- The decisions of the judges will be
              final and binding by/to all regards.
            </h2>{" "}
          </div>
          <br />
        </a>
